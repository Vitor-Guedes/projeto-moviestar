<?php
    ...
    $userOwnsMovie = false;
    if ($userData) {
        $userOwnsMovie = $userData->id === $movie->user_id;
    }

    $alreadyReviwed = $reviewDao->hasAlreadyReviwed($movie->id, $userData->id);
?>
