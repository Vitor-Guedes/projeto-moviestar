...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    <?php if ($userData) : ?>
                        ...
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/newmovie" class="nav-link">
                                <i class="far fa-plus-square"></i> Incluir Filme
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/dashboard" class="nav-link">Meus Filmes</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/edit/profile" class="nav-link bold">
                                <?= $userData->name ?>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <?php else : ?>
                        ...
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/auth" class="nav-link">Entrar | Cadastrar</a>
                        </li>
    ...
    <?php if (isset($flashMessages['message']) && !empty($flashMessages['message'])) : ?>
        <div class="msg-container">
            <p class="msg <?= $flashMessages['type'] ?>"> <?= $flashMessages['message'] ?> </p>
        </div>
    <?php endif ; ?>